...
export const meta = {
  ...
  tags: ['react', 'jest', 'testing-library', 'tutorial', 'english', 'javascript'],
  href: '/en-US/blog/testing-react-hook-form',
  released: true,
  createdAt: "2020-12-30T14:20:53.976Z",
  updatedAt: "2020-12-30T14:20:53.976Z"
};

# React Hook Form is AMAZING (english)

If you never hear about this library, stop reading this article right now and go to the [React Hook Form page](https://react-hook-form.com/).about
...
>
  ...
  <input
    class="w-full text-gray-800 pt-2 pb-2 pr-4 pl-4 border-b-2 border-gray-300 focus:border-gray-500"
    id="form-name"
    name="name"
    placeholder="Ex: George, Mr W, Mary Jane"
    value=""
