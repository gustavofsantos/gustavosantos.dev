...
export const meta = {
  ...
  excerpt: `Você pode anotar, inclusive, type-alias como somente leitura e assim garantir, em tempos de compilação, que sua estrutura de dados não vai ser alterada.`,
  author: 'Gustavo Santos',
  href: '/blog/ts-readonly-type',
  tags: ['typescript'],
  released: true,
  createdAt: "2020-12-22T14:20:53.976Z",
  updatedAt: "2020-12-22T14:20:53.976Z"
}
...
```ts lines=true label=/code/tuple.ts
