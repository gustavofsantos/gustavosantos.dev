...
## React State Management Serie

This article is from the serie of posts about state management in the context of user interface and front-end state management using React as library.

1. [What is state?]() (This article)
2. [Why manage the state?]() (Not published yet)
3. [Types of state]() (Not published yet)
4. [How manage the state]() (Not published yet)
